...
var unatyData = {
    ...
    blogs: [
        {
            name: 'Cannibalism and Competition in Civil Society Organizations',
            link: 'https://blog.unaty.de/cannibalism-and-competition-in-civil-society-organizations-fbff0554691c'
        },
        {
            name: 'Unaty Platform Update #3',
            link: 'https://blog.unaty.de/unaty-platform-update-3-1925a59f1a3d'
        },
        {
            name: 'Changing Engagement of a Changing Society — Symptoms and Causes',
            link: 'https://blog.unaty.de/changing-engagement-of-a-changing-society-symptoms-and-causes-2f18fbb1e6bd'
        }
    ],
    products: [
        {
